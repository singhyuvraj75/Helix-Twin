...
const SysMLBlock = ({ code }) => (
  <div className="bg-white border border-slate-200 rounded-lg p-4 font-mono text-sm overflow-x-auto relative group shadow-sm ring-1 ring-slate-100 flex-1">
      ...
      <header className="h-16 bg-white/90 backdrop-blur border-b border-slate-200 flex items-center justify-between px-6 z-10 sticky top-0">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-semibold text-slate-800 text-base md:text-lg hidden sm:block">Semantic Intent & Requirement Decomposition</h1>
          </div>
        </div>
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="hidden lg:flex items-center gap-4 text-xs">
             <div className="flex items-center gap-1.5 text-slate-600 font-medium">
                <span className="w-2 h-2 rounded-full bg-emerald-500 shadow-[0_0_4px_#10b981] animate-pulse"></span> 
                System Online
             </div>
             <div className="flex items-center gap-1.5">
                <span className="text-slate-400">Model:</span>
                <span className="font-semibold text-slate-700">Llama-3-70b</span>
             </div>
             <div className="flex items-center gap-1.5">
                <span className="text-slate-400">Graph:</span>
                <span className="font-semibold text-slate-700">Neo4j (Active)</span>
             </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <button className="text-sm text-slate-500 hover:text-sky-600 flex items-center gap-1.5 transition-colors font-medium">
              <Save className="w-4 h-4" /> <span className="hidden sm:inline">Save Session</span>
            </button>
      ...
      <div className="flex-1 overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 flex flex-col border-r border-slate-200 bg-white">
          <div className="flex-1 p-6 overflow-y-auto">
            ...
            <div className="bg-white rounded-xl border border-slate-200 font-mono h-[calc(100%-20rem)] min-h-[250px] flex flex-col shadow-sm overflow-hidden">
